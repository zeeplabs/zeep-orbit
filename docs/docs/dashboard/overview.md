...
The web dashboard is embedded in the zeep-orbit binary and accessible at `/dashboard`. It provides a graphical interface to manage your apps, data, and users without editing YAML files.
