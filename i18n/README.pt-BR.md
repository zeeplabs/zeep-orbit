...
| **Build with AI**       | Descreva um app em linguagem natural num drawer de chat, revise o plano proposto (tabelas, auth), confirme para criar — usa uma chave OpenAI configurada pelo superadmin (Gemini/Claude em breve) |
